...
export default function Home() {
  ...
  return (
    <div className="flex h-screen bg-blue-950 overflow-hidden">
      ...
      >
        <h1 className="text-preset-1 text-white mb-4 md:mb-6 lg:mb-8" data-testid="page-title">Home</h1>
        ...
        {showSearchResults ? (
          ...
          <>
            <section className="mb-6 md:mb-8 lg:mb-10" data-testid="trending-section">
              ...
              {isLoadingTrending ? (
                <div className="flex items-center justify-center py-12" data-testid="trending-loading">
                  <div className="w-8 h-8 border-4 border-white/30 border-t-white rounded-full animate-spin" />
                </div>
              ) : (
                <div className="flex gap-3 md:gap-4 overflow-x-auto pb-4 scrollbar-hide -mx-4 px-4 md:mx-0 md:px-0" data-testid="trending-movies">
            ...
            <section data-testid="recommended-section">
              ...
              {isLoadingRecommended ? (
                <div className="flex items-center justify-center py-12" data-testid="recommended-loading">
                  <div className="w-8 h-8 border-4 border-white/30 border-t-white rounded-full animate-spin" />
                </div>
              ) : (
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4 lg:gap-6" data-testid="recommended-movies">
